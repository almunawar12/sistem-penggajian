...
class AdminController extends Controller
{
    ...
    public function fetchNotifications()
    {
        ...
        $dataNotif = Rekap::join('detail_pesanan', 'rekap_jahitan.id_detail', '=', 'detail_pesanan.id')
            ...
            ->select(
                'rekap_jahitan.*',
                'karyawan.nama_kry AS karyawan',
                'pesanan.nama_pemesan',
                'detail_pesanan.nama_pcs',
                'busana.jenis_busana',
                'tugas_karyawan.nama_kry as karyawan_tugas',
                'pesanan.tgl_pengambilan'
            )
    ...
    public function rekapDetail($id)
    {
        ...
        $data = Pesanan::join('detail_pesanan', 'pesanan.id', '=', 'detail_pesanan.id_pesanan')
            ...
            ->select(
                'pesanan.*',
                'detail_pesanan.nama_pcs',
                'detail_pesanan.id_karyawan',
                'karyawan_tugas.nama_kry as karyawan_tugas',
                'karyawan_pengerja.nama_kry as karyawan_pengerja',
                'rekap_jahitan.id_pengerja',
                'rekap_jahitan.created_at AS tgl_selesai'
            )
            ->where('pesanan.id', $id)
